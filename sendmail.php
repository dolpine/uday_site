...
// email
define('TO_EMAIL', 'udaymishra22@gmail.com'); 
define('FROM_EMAIL', 'udaymishra22@gmail.com');  
define('FROM_NAME', 'uday'); 
 ...
 * email: %email%   
 */ 
define( 'BODY', '%message%<br /><br /><small>invite to %name%, email %email%.</small>' );
define( 'SUBJECT', 'Email from udaymishra22@gmail.com' );
